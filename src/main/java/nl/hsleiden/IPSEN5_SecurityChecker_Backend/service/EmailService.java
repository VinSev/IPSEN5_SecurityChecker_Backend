...
public class EmailService {
    ...
    public void sendEmailWithPDFAttachment(Report report) throws MessagingException {
        ...
        messageHelper.addAttachment(String.format("Get Big Marketing Security Scan Resultaten - %s.pdf", new SimpleDateFormat("dd/MM/yyyy").format(new Date())), new ClassPathResource("/pdf/%s.pdf"));
